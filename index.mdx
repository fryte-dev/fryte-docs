...
The FRYTE API plans routes for electric trucks. Given an origin, destination, and vehicle, it returns where and how long to charge — optimized for time, energy, and cost. All requests use the base URL `https://api.fryte.com`.

...
<CodeGroup>
```bash curl
curl -X POST "https://api.fryte.com/planner/v2?min_charge_duration_min=10" \
  ...
  -d '{
    ...
    "section_list": [
      {
        "start_pos": [51.9851, 5.8987],
        "stop_pos": [52.6324, 4.7534],
        "payload_kg": 19300
      },
      {
        "start_pos": [52.6324, 4.7534],
        "stop_pos": [51.9851, 5.8987],
        "payload_kg": 19300
      }
    ],
    "poi_info": {
...
const response = await fetch(
  "https://api.fryte.com/planner/v2?min_charge_duration_min=10",
  {
    method: "POST",
    headers: {

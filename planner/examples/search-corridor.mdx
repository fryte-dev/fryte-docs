...
<Frame caption="Without the filter the optimizer picks a charger on an industrial street near Almere; with truck_approved=T it picks a truck-capable highway rest area — and arrives earlier, because the truck-ready site charges at 400 kW.">
  <img src="/images/planner/truck-ready-comparison.png" alt="Two maps of the Amsterdam to Groningen route. Left: without the truck filter, 75 candidate stations including inner-city clusters; the chosen stop is Spirii on an industrial street. Right: with truck_approved T, 12 candidates along the highway; the chosen stop is a Fastned A6 rest area." />
</Frame>
